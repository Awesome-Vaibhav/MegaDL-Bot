...
class Config:
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5457463964:AAHvbTRsUIU4KTNGlOVDdF1jkXSSmDqEEcg")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    TG_MAX_SIZE = 2040108421
    OWNER_ID = int(os.environ.get("OWNER_ID", 1144738419))
    LOG_CHANNEL = -1001686200896
